...
keyvisual: /assets/img/portfolio/merch/DH_keyvisual.png
...
{::nomarkdown}
    <div class="gallery-stickers content__gallery case__gallery">
      ...
      <img src="/sobolstudio/assets/img/portfolio/merch/DH_sticker7.svg" alt="Стикер с текстом: Am I testing the code, or it’s the code testing me?">
      <img src="/sobolstudio/assets/img/portfolio/merch/DH_sticker8.svg" alt="Стикер с текстом: ✗ frontend ✗ backend ✓ weekend. Делу время – потехе час">
      <img src="/sobolstudio/assets/img/portfolio/merch/DH_sticker9.svg" alt="Стикер со шкалами hp, mp и хз, с I dunno kaomoji">
      <img src="/sobolstudio/assets/img/portfolio/merch/DH_sticker10.svg" alt="Стикер с предупреждением: ВНИМАНИЕ Пожалуйста, не приближайтесь с тупыми вопросами. Отсылка на нелюдимый характер программиста">
      <img src="/sobolstudio/assets/img/portfolio/merch/DH_sticker11.svg" alt="Стикер с таблицей визитка.json. Предлагает написать себе визитку в json-формате">
      <img src="/sobolstudio/assets/img/portfolio/merch/DH_sticker12.svg" alt="Стикер с окном brain.exe и прогрессбаром: brain.exe has been stopped working. Поиск дополнительных проблем...">
    </div>
{:/nomarkdown}
...
Никаких сюрпризов, чёткие сроки, предсказуемый результат. Заказчик всегда в курсе этапа. Мной не нужно управлять. Готовый пакет получен в оговоренные сроки
